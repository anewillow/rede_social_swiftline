# Trabalho 1 — Manutenção corretiva
...
- [Apresentação do sistema e instruções de execução](./docs/apresentacao-sistema.md)
- [Identificação e classificação dos bugs](./docs/bugs-e-classificacao.md)
